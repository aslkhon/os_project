...
import 'package:os_project/services/image_converter_service.dart';
...
class MLService {
  ...
  Future<StudentRecord?> predict() async {
  ...
  Future<StudentRecord?> _searchResult(List predictedData) async {
    final dbService = locator<DBService>();

    List<StudentRecord> students = dbService.students;
    double minDist = 999;
    double currDist = 0.0;
    StudentRecord? predictedResult;
